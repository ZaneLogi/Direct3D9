// Basic09_more_on_lighting.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "Basic09_more_on_lighting.h"
...
void render_frame(void)
{
    ...
    XMMATRIX matTranslate;    // the world transform matrix
    matTranslate = XMMatrixTranslation(
...
void init_light(void)
{
    ...
    light.Diffuse = *(D3DCOLORVALUE*)&XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f);
    light.Position = *(D3DVECTOR*)&XMFLOAT3(0.0f, 5.0f, 0.0f);
    ...
    material.Diffuse = *(D3DCOLORVALUE*)&XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
    material.Ambient = *(D3DCOLORVALUE*)&XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
